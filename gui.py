...
for x in range(11):
    for y in range(11):
        Label(gui, width=1, bg='#C6C6C6').grid(row=y,
                                               column=x,
                                               sticky=N + S + E + W)
init = True
gui.label = Label(gui,
...
gui.success1 = Label(gui,
                     ...
                     fg='#000000',
                     bg='#c6c6c6')
gui.success1.grid(row=8,
                  column=2,
                  columnspan=3,
                  rowspan=1,
                  sticky=N + S + E + W)
gui.success2 = Label(gui,
                     text="",
                     font=('Arial', 16),
                     width=1,
                     height=1,
...
gui.nfm1go = Button(gui,
                    text="Restart NFM1",
                    font=('Arial', 16),
                    width=1,
                    height=1,
                    fg='#000000',
                    command=lambda: runrestart_game("nfm1go"),
                    bg='#00FFFF')
gui.nfm1go.grid(row=6, column=2, columnspan=3, rowspan=2, sticky=N + S + E + W)
gui.nfm2go = Button(gui,
                    text="Restart NFM2",
                    font=('Arial', 16),
                    width=1,
                    height=1,
                    fg='#000000',
                    command=lambda: runrestart_game("nfm2go"),
                    bg='#00FFFF')
gui.nfm2go.grid(row=6, column=6, columnspan=3, rowspan=2, sticky=N + S + E + W)
gui.browse = Button(gui,
                    text="Browse",
                    font=('Arial', 14),
                    width=1,
                    height=1,
                    fg='#000000',
                    command=lambda: runopenfile("browse"),
                    bg='#00FFFF')
